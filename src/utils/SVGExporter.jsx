import "../animations/JumpAnimation.css";
export const Brainly = () => {
  return (
    <svg
      width={30}
      height={30}
      ...
      className="jumper icon icon-tabler icons-tabler-outline icon-tabler-bulb inline"
    >
...
export const News = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="icon icon-tabler icons-tabler-outline icon-tabler-news"
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
